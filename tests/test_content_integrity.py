...
franksbooklog.com renders this content with Satteri, which emits raw HTML verbatim and pairs
...
CONTENT_FOLDER_NAMES = ("readings", "reviews")
...
def prose_only(paragraph: str) -> str:
    """Drop code and HTML tags, whose quotes are literal syntax rather than prose."""
    return HTML_TAG.sub("", INLINE_CODE.sub("", FENCED_CODE.sub("", paragraph)))
